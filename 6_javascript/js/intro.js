...
document.getElementById('column1').innerHTML="<h3> Whateverrrrr I want </h3> <p>look at me go!<p>";
//=+ 
...
document.getElementById("column2").style.size="60pt";
...
if(animal=="kiwi"){
    console.log("you battle with the kiwi");
}
else{
    console.log("you freaking explode");
}
...
// if the wepon = fists 
//then change the inner html of column 3 to say "<p>you are using fists"
//else if wepon = squids
...
if(weapon == "Fists"){
    ...
    document.getElementById("column3").innerHTML += "<p> You are using Squids </p>"
}
else{
     document.getElementById("column3").innerHTML += "<p> Your wepon wont work here </p>"
}
let damage = 0;
